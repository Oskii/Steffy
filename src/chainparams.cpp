...
#define GENESIS_TIME 1521175460 //16/03/2018 3:44pm
...
{
    const char* pszTimestamp = "E82E16850F9D9328DFF1C47AF4EBD96AD20EB739AD8759A61A9C4249DB095AAE";
...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00005767d6cedbde9a70f41aafe64a6499199c9862d04aef2e67003b40992ef1"));
        ...
        vSeeds.push_back(CDNSSeedData("45.76.119.25" /*Steffy 1*/, "45.76.122.61" /*Steffy 2*/));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(GENESIS_TIME, 44432946, GENESIS_DIFFICULTY, 1, 50 * COIN);
	    
        //MineGenesisBlock(genesis);

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00003faaf2d6f2092d8eeab47935eeee36365d1c1a2ba7053b281e3444c37b7a"));
        assert(genesis.hashMerkleRoot == uint256S("0xdfff2a87da64463797f5cb1cb91b072ecae10b9b4b8b24f796ba35bcbf65ad49"));
...
public:
	...
	genesis = CreateGenesisBlock(GENESIS_TIME, 917049555, GENESIS_DIFFICULTY, 1, 50 * COIN);
	
        //MineGenesisBlock(genesis);
 
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000017559b830105617f2c21e08a7a9785013102017624660ce27e0e043ef246"));
        assert(genesis.hashMerkleRoot == uint256S("0xdfff2a87da64463797f5cb1cb91b072ecae10b9b4b8b24f796ba35bcbf65ad49"));
